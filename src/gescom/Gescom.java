...
public class Gescom {
    ...
    private static void afficherArticle(Article unArticle) {
        /* A compléter */
        System.out.println("ID: " + unArticle.getIdArticle() + ", Désignation: " + unArticle.getDesignation());
    }
    ...
    private static void afficherCaClients(Representant unRepresentant) {
        ...
        for (Client client : unRepresentant.getLesClients()) {
            client.cumulCA();
            System.out.println("Client ID: " + client.getIdClient() + ", Raison sociale: " + client.getRaisonSociale() + ", CA: " + client.getCaClient());
        }
    }
    ...
    private static void supprimerLigne(Representant unRepresentant) {
        ...
        if (client != null) {
            ...
            if (commande != null) {
                ...
                Ligne ligne = commande.chercherLigne(idArticle, bdd);
                if (ligne != null) {
    ...
    private static void afficherCommande(Commande uneCommande) {
        /* A compléter */
        System.out.println("Commande ID: " + uneCommande.getIdCommande() + ", Date: " + uneCommande.getDateCommande());
        for (Ligne ligne : uneCommande.getLesLignes()) {
            System.out.println("Article ID: " + ligne.getUnArticle().getIdArticle() + ", Désignation: " + ligne.getUnArticle().getDesignation() + ", Quantité: " + ligne.getQteCommande());
        }
    }
